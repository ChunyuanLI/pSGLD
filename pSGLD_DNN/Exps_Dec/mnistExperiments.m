function [exps,data,resultsPath] = mnistExperiments(expSet,nonLin,sz)
global gpu;
...
%nonLin = 'ReLU';
resultsPath = sprintf('exps/mnist-%s-%d-FFNN-%s-fresh.mat',expSet,sz,nonLin)
exps = {};
...
sizes = [prod(data.inSize) sz sz data.outSize];
NNFactory = @() SimpleNN(sizes, nonLin, gpu);
